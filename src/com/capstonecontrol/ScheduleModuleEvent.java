...
public class ScheduleModuleEvent {
	String moduleName;
	String value;
	String moduleType;
	String user;
	...
	public ScheduleModuleEvent(String moduleName, String moduleType,
	...
	public static ScheduleModuleEvent findModuleInfo(Long id) {
		return null;
